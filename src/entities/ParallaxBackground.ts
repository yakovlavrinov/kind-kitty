export class ParallaxBackground {
  ...
  create() {
    ...
    // Слой 1: дальний фон
    this.layers.background = this.scene.add
    ...
    this.layers.city4 = this.scene.add
      .tileSprite(0, height, width, height, 'city4plan')
      .setOrigin(0, 1)

    // Слой 4: следующий слой зданий
    this.layers.city3 = this.scene.add
      .tileSprite(0, height, width, height, 'city3plan')
      .setOrigin(0, 1)
    ...
    this.layers.city2 = this.scene.add
      .tileSprite(0, height, width, 360, 'city2plan')
      .setOrigin(0, 1)
    ...
    this.layers.city1 = this.scene.add
      .tileSprite(0, height, width, 360, 'city1plan')
      .setOrigin(0, 1)
  }
